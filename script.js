...
// Import the functions you need from the SDKs you need
    ...
    import { getAuth, signInWithEmailAndPassword, onAuthStateChanged, sendEmailVerification} from "https://www.gstatic.com/firebasejs/9.17.2/firebase-auth.js";
    import {collection, getFirestore, getDocs} from "https://www.gstatic.com/firebasejs/9.17.2/firebase-firestore.js";
    ...
    onAuthStateChanged(auth, async (user) => {
        if (user.emailVerified) {
          ...
          .then(() => {
            Toast.fire({
              icon: 'success',
              title: 'Email Verification send successfully!'
            })
          });
        }
    })
